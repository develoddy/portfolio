                    ...
                    <div class="bd__menu-tab">
                        <ul class="bd__menu nav" id="myTab" role="tablist">
                            <li class="bd__btn-item" role="presentation">
                                <button class="active" id="view-tab" data-bs-toggle="tab" data-bs-target="#view" type="button" role="tab" aria-controls="view" aria-selected="true">View All</button>
                            </li>
                            <li class="bd__btn-item" role="presentation">
                            ...
                            <li class="bd__btn-item" role="presentation">
                                <button id="project-tab" data-bs-toggle="tab" data-bs-target="#project" type="button" role="tab" aria-controls="project" aria-selected="false">Project</button>
                            </li>
                            <li class="bd__btn-item" role="presentation">
                        ...
                        <div class="tab-pane fade show active" id="view" role="tabpanel" aria-labelledby="view-tab">
                            <div class="row  g-5">
                                <div class="col-lg-4 col-md-6">
                                    <div class=" portfolio__item style-seven">
                                        <div class="portfolio__item-thumb">
                                            <img src="{{ Vite::asset('resources/imgs/portfolio/portfolio-08.png') }}" alt="image not found">
                                            <div class="portfolio__item-btn">
                                                <span class="icon__box">
                                      <a class="popup-image circle-btn is-bg-white is-btn-large"
                                         href="{{ Vite::asset('resources/imgs/portfolio/portfolio-08.png') }}"> <i
                                            class="icon-plus"></i></a>
                                   </span>
                                            </div>
                                        </div>
                                        <div class="portfolio__item-content">
                                            <div class="portfolio__item-info">
                                                <div class="portfolio__tag">
                                                    <a href="{{ route('portfolio-detail', ['portfolio' => 'slug-details']) }}">Mockup</a>
                                                </div>
                                                <h5 class="portfolio__item-title underline"><a href="{{ route('portfolio-detail', ['portfolio' => 'slug-details']) }}">Design With Mockup</a></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6">
                                    <div class=" portfolio__item style-seven ">
                                        <div class="portfolio__item-thumb">
                                            <img src="{{ Vite::asset('resources/imgs/portfolio/portfolio-02.png') }}" alt="">
                                            <div class="portfolio__item-btn">
                                                <span class="icon__box">
                                      <a class="popup-image circle-btn is-bg-white is-btn-large"
                                         href="{{ Vite::asset('resources/imgs/portfolio/portfolio-02.png') }}"> <i
                                            class="icon-plus"></i></a>
                                   </span>
                                            </div>
                                        </div>
                                        <div class="portfolio__item-content">
                                            <div class="portfolio__item-info">
                                                ...
                                                <h5 class="portfolio__item-title underline"><a href="portfolio-details.html">Creative Idea is key</a></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6">
                                    <div class=" portfolio__item style-seven">
                                        <div class="portfolio__item-thumb">
                                            <img src="{{ Vite::asset('resources/imgs/portfolio/portfolio-12.png') }}" alt="image not found">
                                            <div class="portfolio__item-btn">
                                                <span class="icon__box">
                                      <a class="popup-image circle-btn is-bg-white is-btn-large"
                                         href="{{ Vite::asset('resources/imgs/portfolio/portfolio-12.png') }}"> <i
                                            class="icon-plus"></i></a>
                                   </span>
                                            </div>
                                        </div>
                                        <div class="portfolio__item-content">
                                            <div class="portfolio__item-info">
                                                ...
                                                <h5 class="portfolio__item-title underline"><a href="portfolio-details.html">Creative Idea Combines Technology</a></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6">
                                    <div class=" portfolio__item style-seven">
                                        <div class="portfolio__item-thumb">
                                            <img src="{{ Vite::asset('resources/imgs/portfolio/portfolio-05.png') }}" alt="image not found">
                                            <div class="portfolio__item-btn">
                                                <span class="icon__box">
                                      <a class="popup-image circle-btn is-bg-white is-btn-large"
                                         href="{{ Vite::asset('resources/imgs/portfolio/portfolio-05.png') }}"> <i
                                            class="icon-plus"></i></a>
                                   </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class=" portfolio__item style-seven">
                                        <div class="portfolio__item-thumb">
                                            ...
                                            <div class="portfolio__item-btn">
                                                <span class="icon__box">
                                      <a class="popup-image circle-btn is-bg-white is-btn-large"
                                         href="{{ Vite::asset('resources/imgs/portfolio/portfolio-10.png') }}"> <i
                                            class="icon-plus"></i></a>
                                   </span>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class=" portfolio__item style-seven">
                                        <div class="portfolio__item-thumb">
                                            <img src="{{ Vite::asset('resources/imgs/portfolio/portfolio-11.png') }}" alt="">
                                            <div class="portfolio__item-btn">
                                                <span class="icon__box">
                                      <a class="popup-image circle-btn is-bg-white is-btn-large"
                                         href="{{ Vite::asset('resources/imgs/portfolio/portfolio-11.png') }}"> <i
                                            class="icon-plus"></i></a>
                                   </span>
                                            </div>
                                        </div>
                                        <div class="portfolio__item-content">
                                            <div class="portfolio__item-info">
                                                ...
                                                <h5 class="portfolio__item-title underline"><a href="portfolio-details.html">Digital Art is Creative</a></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6">
                                    <div class=" portfolio__item style-seven">
                                        <div class="portfolio__item-thumb">
                                            <img src="{{ Vite::asset('resources/imgs/portfolio/portfolio-09.png') }}" alt="">
                                            <div class="portfolio__item-btn">
                                                <span class="icon__box">
                                      <a class="popup-image circle-btn is-bg-white is-btn-large"
                                         href="{{ Vite::asset('resources/imgs/portfolio/portfolio-09.png') }}"> <i
                                            class="icon-plus"></i></a>
                                   </span>
                                            </div>
                                        </div>
                                        <div class="portfolio__item-content">
                                            <div class="portfolio__item-info">
                                                ...
                                                <h5 class="portfolio__item-title underline"><a href="portfolio-details.html">Implement Dynamic Lighting to Highlight</a></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6">
                                    <div class=" portfolio__item style-seven">
                                        <div class="portfolio__item-thumb">
                                            <img src="{{ Vite::asset('resources/imgs/portfolio/portfolio-04.png') }}" alt="">
                                            <div class="portfolio__item-btn">
                                                <span class="icon__box">
                                      <a class="popup-image circle-btn is-bg-white is-btn-large"
                                         href="{{ Vite::asset('resources/imgs/portfolio/portfolio-04.png') }}"> <i
                                            class="icon-plus"></i></a>
                                   </span>
                                            </div>
                                        </div>
                                        <div class="portfolio__item-content">
                                            <div class="portfolio__item-info">
                                                ...
                                                <h5 class="portfolio__item-title underline"><a href="portfolio-details.html">Design Flexible Layouts That Can Adapt</a></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6">
                                    <div class=" portfolio__item style-seven">
                                        <div class="portfolio__item-thumb">
                                            <img src="{{ Vite::asset('resources/imgs/portfolio/portfolio-13.png') }}" alt="">
                                            <div class="portfolio__item-btn">
                                                <span class="icon__box">
                                      <a class="popup-image circle-btn is-bg-white is-btn-large"
                                         href="{{ Vite::asset('resources/imgs/portfolio/portfolio-13.png') }}"> <i
                                            class="icon-plus"></i></a>
                                   </span>
                                            </div>
                                        </div>
                                        <div class="portfolio__item-content">
                                            <div class="portfolio__item-info">
                                                ...
                                                <h5 class="portfolio__item-title underline"><a href="portfolio-details.html">Illustrate Renewable Energy Sources</a></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                      ...
                                      <a class="popup-image circle-btn is-bg-white is-btn-large"
                                        ...
                                        <div class="portfolio__item-content">
                                            <div class="portfolio__item-info">
                                                ...
                                                <h5 class="portfolio__item-title underline"><a href="portfolio-details.html">Design With Mockup</a></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
