...
class DataRowsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $dataRow = $this->dataRow($portfolioDataType, 'description');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
                'display_name' => 'Description',
        ...
        $dataRow = $this->dataRow($portfolioDataType, 'created_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'Created At',
        ...
        $dataRow = $this->dataRow($portfolioDataType, 'updated_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
        ...
        $dataRow = $this->dataRow($portfolioDetailDataType, 'description');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
                'display_name' => 'Description',
        ...
        $dataRow = $this->dataRow($portfolioDetailDataType, 'client');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
                'display_name' => 'Client',
        ...
        $dataRow = $this->dataRow($portfolioDetailDataType, 'awards');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
                'display_name' => 'Awards',
        ...
        $dataRow = $this->dataRow($portfolioDetailDataType, 'category');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
        ...
        $dataRow = $this->dataRow($portfolioDetailDataType, 'created_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'Created At',
        ...
        $dataRow = $this->dataRow($portfolioDetailDataType, 'updated_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'Updated At',
